  ...
  return (
    <div className='flex lg:justify-between items-center max-lg:flex-col   '>
      ...
      <div className='lg:w-[50%] overflow-hidden  max-lg:relative '>
        <Image src="/hero.png" height={300} width={300} className='lg:w-[75%]  ' alt="" />
        <Image src="/hero-bg.png" height={300} width={300} className='absolute top-[-30]   right-[-400] xl:h-[50rem]  z-[-1] w-[65%] max-lg:w-full max-lg:top-[-10] max-lg:left-20' alt="" />
      </div>
    </div>
  )
}
